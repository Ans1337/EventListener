        ...
        <>
            ...
            <div className='subgraph-background'>
                <div className="subgraph-address-div">
                    ...
                    <button onClick={submitContractAddress} className="subgraph-button">Next</button>
                </div>
                <div className="subgraph-temp">
                    {events.length > 0 && <h1 className="">Events Available</h1>}
                ...
                <div>
                    {events.length > 0 &&
                        <div>
                            ...
                            <button onClick={(e) => createListener(e)}>Start Listening</button>
                        </div>
                    }
                </div>
            </div>
